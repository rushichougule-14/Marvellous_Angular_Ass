...
void Insert(PPNODE Root,int No)
{
    ...
    else
    {
        while(1)
        {
            ...
            {
                free(newn);
                printf("Duplicate Element are not allowed...");
                break;
            }
        }
...
bool Search(PNODE Root, int No)  // Pahila Address asto PNODE
{
    bool flag = false;
    while (Root != NULL)
    {
